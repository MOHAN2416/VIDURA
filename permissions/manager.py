...
class PermissionManager:
    ...
    def __init__(self, default_write_allowed: bool = False, default_test_allowed: bool = False) -> None:
        self._write_allowed = bool(default_write_allowed)
        self._test_allowed = bool(default_test_allowed)
    ...
    def is_test_allowed(self, test_target: str | None = None) -> bool:
        """Checks if test execution is authorized."""
        return self._test_allowed
    ...
    def grant_test_permission(self, test_target: str | None = None) -> None:
        """Explicitly grants test execution permission."""
        logger.info(f"Test execution permission EXPLICITLY GRANTED for target: {test_target or 'all tests'}")
        self._test_allowed = True

    def revoke_test_permission(self) -> None:
        """Revokes test execution permission."""
        logger.info("Test execution permission REVOKED.")
        self._test_allowed = False
